...
export const LEAGUE_CONFIG: Record<string, LeagueConfig> = {
  ...
  cba:              { sportType: 'basketball', displayName: 'CBA',      apiHost: API_HOSTS.basketball, leagueId: 264, season: '2025-2026' },
  't1-league':      { sportType: 'basketball', displayName: 'T1 聯盟',  apiHost: API_HOSTS.basketball, leagueId: 327, season: '2025-2026' },
  tpbl:             { sportType: 'basketball', displayName: 'TPBL',     apiHost: API_HOSTS.basketball, leagueId: 327, season: '2025-2026' },
  'b-league':       { sportType: 'basketball', displayName: 'B.League', apiHost: API_HOSTS.basketball, leagueId: 99,  season: '2025-2026' },
  kbl:              { sportType: 'basketball', displayName: 'KBL',      apiHost: API_HOSTS.basketball, leagueId: 112, season: '2025-2026' },
  ...
  cpbl:             { sportType: 'baseball', displayName: '中華職棒',  apiHost: API_HOSTS.baseball, leagueId: 12, season: 2026 },
  npb:              { sportType: 'baseball', displayName: '日本職棒',  apiHost: API_HOSTS.baseball, leagueId: 2,  season: 2026 },
  kbo:              { sportType: 'baseball', displayName: '韓國職棒',  apiHost: API_HOSTS.baseball, leagueId: 3,  season: 2026 },
};
