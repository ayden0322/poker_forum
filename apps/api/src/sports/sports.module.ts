...
@Module({
  imports: [MLBStatsModule, BaseballCommonModule, CpblStatsModule, NpbStatsModule, KboStatsModule],
  controllers: [SportsController],
  providers: [SportsService],
  exports: [SportsService, MLBStatsModule, BaseballCommonModule, CpblStatsModule, NpbStatsModule, KboStatsModule],
})
